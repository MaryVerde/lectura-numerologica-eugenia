...
# =====================================================
# 🔑 GENERAR CLAVE PREMIUM (ADMIN / FINANCE)
# =====================================================
st.markdown("### 🧾 Generar clave Premium")

st.caption(
    "Genera la clave usando el nombre completo y la fecha de nacimiento. "
    "Copia esta clave y entrégala al cliente."
)

if st.button("🔐 Generar clave para este usuario"):
    clave_generada = generar_clave_unica(nombre_completo, fecha_nac)

    st.success("Clave Premium generada correctamente")
    st.code(clave_generada, language="text")

    st.caption(
        "📌 Esta es la clave que el cliente debe introducir más abajo "
        "en «Ingresa tu clave Premium»."
    )
# ---- Validación de clave ----
